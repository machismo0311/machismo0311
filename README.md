...
- **FOQA flight-data analysis** → observability, anomaly detection, metrics-driven troubleshooting
- **Instructor-pilot checklist discipline** → runbooks, change control, repeatable procedures
- **Mission-critical systems thinking** → reliability, redundancy, backups, and blast-radius analysis

## 📫 Contact

- 📧 [kyle@kylemason.org](mailto:kyle@kylemason.org)
- 💼 [LinkedIn](https://www.linkedin.com/in/kyle-m-468592bb/)
